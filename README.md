# VerificaFarma — Save Concept

Portal de autenticação de produtos e gestão de clientes, com base central D1, consentimento granular, benefícios e painel administrativo protegido.
