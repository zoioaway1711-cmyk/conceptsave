(() => {
  ...
  const apply = (theme) => {
    ...
    document.querySelector('meta[name="theme-color"]')?.setAttribute("content", theme === "dark" ? "#071322" : "#f3f7fc");
  ...
  const current = () => preference === "light" || preference === "dark" ? preference : system.matches ? "dark" : "light";
  apply(current());
