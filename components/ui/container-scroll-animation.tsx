...
export const Card = ({
  ...
  <motion.div
    ...
    className="mx-auto -mt-12 h-[30rem] w-full max-w-5xl rounded-[30px] border-4 border-[#7fa991] bg-[#11281f] p-2 shadow-2xl md:h-[40rem] md:p-6"
  >
    <div className="h-full w-full overflow-hidden rounded-2xl bg-[#f7f8f2] md:p-4">
      {children}
    </div>
  </motion.div>
);
